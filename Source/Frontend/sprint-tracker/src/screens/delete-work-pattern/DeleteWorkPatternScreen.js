...
import {} from "./DeleteWorkPatternScreen.scss";
import {} from "./DeleteWorkPatternScreen.css";

class DeleteWorkPatternScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  submitHandler(e) {
    ...
    alert("The Work Pattern with ID  " + this.state.input + " will be deleted.");
    ...
    fetch(`${URL}/workPattern/${this.state.input}`, { method: "delete" }).then(
      async (response) => {
  ...
  render() {
    ...
    return (
      <div>
        <h1>Delete Working Patterns</h1>
        <h3>Current Work Patterns</h3>
        ...
        <br />
        <h3>Delete Work Pattern Form</h3>
        <h6>Fill in the ID and press delete to permanently remove a work pattern.</h6>
        <form onSubmit={this.submitHandler.bind(this)}>
          ...
          />
          <br />
          <input type="submit" value="Delete Working Pattern" />
        </form>
      </div>
    );
  }
...
export default DeleteWorkPatternScreen;
